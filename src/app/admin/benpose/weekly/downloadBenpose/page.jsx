...
const DownloadBenpose = () => {
  ...
  const handleFullBenpose = (e) => {
    e.preventDefault();
    const url = `/admin/benpose/weekly/benposData?date=${encodeURIComponent(
      fullForm.date
    )}&isin=${fullForm.isin}&benposType=weekly&fullOrShort=full`;
    router.push(url);
  };

  const handleShortBenpose = (e) => {
    e.preventDefault();
    const url = `/admin/benpose/weekly/benposData?date=${encodeURIComponent(
      shortForm.date
    )}&isin=${shortForm.isin}&benposType=weekly&fullOrShort=short`;
    router.push(url);
  };
  ...
  const handleReport311 = (e) => {
    ...
    const url = `/admin/benpose/weekly/weeklyReport311Benpos?date=${encodeURIComponent(
      report311Form.date
    )}&isin=${report311Form.isin}&benposType=weekly`;
    router.push(url);
  };
  ...
  const handleChangeReport = (e) => {
    ...
    const url = `/admin/benpose/weekly/weeklyChangeReport?date=${encodeURIComponent(
      changeForm.date
    )}&isin=${changeForm.isin}&benposType=weekly`;
    router.push(url);
  };
