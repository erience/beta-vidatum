...
const CdslBenposeUpload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!date) return alert("Please select a Benpose Date.");
    if (files.length === 0) {
    ...
    formData.append("date", formatDMY(date));
...
export default CdslBenposeUpload;
