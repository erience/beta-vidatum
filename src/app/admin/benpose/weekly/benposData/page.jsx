...
const BenposData = () => {
  ...
  const { date, isin, benposType, fullOrShort } = useQueryParams();
  ...
  useEffect(() => {
    if (fullOrShort) {
      setSelectedFields(requiredFields[fullOrShort]);
    }
  }, [fullOrShort]);
  ...
  const fetchBenposData = async () => {
    ...
    try {
      ...
      const response = await apiConnector(
        "POST",
        `${apiUrl}/v2/admin/benpose/search_benpose_record`,
        submitData
      );

      const { cdslCount, nsdlCount, data: records } = response.data.data;
      ...
      const enrichedRecords = records.map((item) => ({
        ...item,
        date,
        isin: isin, // ensure isin is available in each row
      }));
  ...
  }, [date, isin, benposType, fullOrShort, selectedFields]);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-white rounded shadow">
              <div className="flex h-full">
                <div className="w-1/4 bg-blue-500 flex items-center justify-center text-white"></div>
            ...
            <div className="bg-white rounded shadow">
              <div className="flex h-full">
                <div className="w-1/4 bg-green-500 flex items-center justify-center text-white"></div>
                <div className="w-3/4 p-4 text-right">
            ...
            <div className="bg-white rounded shadow">
              <div className="flex h-full">
                <div className="w-1/4 bg-cyan-500 flex items-center justify-center text-white"></div>
                <div className="w-3/4 p-4 text-right">
            ...
            <div className="bg-white rounded shadow">
              <div className="flex h-full">
                <div className="w-1/4 bg-yellow-500 flex items-center justify-center text-white"></div>
                <div className="w-3/4 p-4 text-right">
                  <h2 className="text-2xl font-normal mb-2">
                    {nsdlCountData || 0}
                  </h2>
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="bg-orange-500 text-white px-4 py-2 rounded hover:bg-primary-color flex items-center"
              >
