  ...
  const fetchAnnexurData = async () => {
    ...
    try {
      const response = await apiConnector(
        "GET",
        `${apiUrl}/v2/admin/process/download-data-of-annexure-final?id=${decodedId}&table=b_inward&isin=b_isin`
      );
        ...
        <div className="max-w-4xl mx-auto p-2">
            ...
            <div className="container max-w-[1090px]">
              <div className="flex items-center py-2">
                ...
                <div className="w-[85%] border-b-[2px] border-[#e6e6e6] pl-4">
                  <p className="block text-lg leading-[2]">Vidatum Solution</p>
                </div>
              </div>
            </div>
          </header>
          <div className="mx-auto w-[210mm] min-h-[280mm] text-[14px]  flex flex-col justify-between">
            <div className="container max-w-[1090px]">
              <div className="w-full">
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-2  text-[14px]">
                    <p>Thanking you.</p>
                    <p>For, Vidatum Securities & Registry Private Limited</p>
                    <div className="mt-10">
                      <p>
                        (Nikita Sharma)
                        <br />
            ...
            <footer className="w-full mt-8 text-[14px]">
              ...
              <div className="w-full !bg-black mt-3"></div>
            </footer>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto p-2">
            ...
            <div className="mx-auto w-[210mm] min-h-[280mm] text-[14px]  flex flex-col justify-between">
              ...
              <footer className="w-full mt-8 text-[14px]">
                ...
                <div className="w-full !bg-black mt-3 text-[14px]"></div>
              </footer>
            </div>
          </div>
        </div>
