...
const DuplicateShareCertificate = () => {
  ...
  //----------------------fetch DuplicateShareCertificate  data-----------------------------

  const fetchDuplicateData = async () => {
    try {
      const response = await apiConnector(
        "GET",
        `${apiUrl}/v2/admin/process/duplicate-share-certi?table=b_inward&isin=b_isin`
      );
    ...
    <>
      <div className="card">
        <div className="card-body">
          ...
          <ViewDataTable
            title="Duplicate Share Inward Process"
            cardHeader="duplicate share certificate data"
            columns={columns}
