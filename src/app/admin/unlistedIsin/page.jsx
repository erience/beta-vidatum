...
import { CheckLine, Download, Eye, Upload } from "lucide-react";
...
const UnlistedIsin = () => {
  ...
  const fetchIsinData = async () => {
    try {
      ...
      const privateData = responseData.filter(
        (item) => item.type === "Unlisted"
      );
