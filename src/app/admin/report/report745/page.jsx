...
const Report74 = () => {
  ...
  //----------------------fetch report745 data-----------------------------
  const fetchReport745 = async () => {
    try {
      const response = await apiConnector(
        "GET",
        `${apiUrl}/v2/admin/report/report745`
      );
  ...
  const checkAddressFunction = async (isin, id) => {
    try {
      ...
      if (data.status) {
        ...
        const url = `/admin/report/downlaodReport745/${btoa(id)}`;
      ...
      <div className="card">
        <div className="card-body">
          <ViewDataTable
            ...
            //     <Link href="/admin/report/add_report745">
