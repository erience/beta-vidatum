...
const Report133 = () => {
  ...
  //----------------------fetch report133 data-----------------------------
  const fetchReport133 = async () => {
    try {
      const response = await apiConnector(
        "GET",
        `${apiUrl}/v2/admin/report/report133`
      );
  ...
  const checkAddressFunction = async (isin, id) => {
    try {
      ...
      if (data.status) {
        ...
        const url = `/admin/report/downloadReport133/${btoa(id)}`;
