...
const OutwardFileFormate = () => {
    const tableData = [
        {
            description: " Add New Outward File Format Download",
            formateLink: "/assets/file_format/add_outward.csv"
        },
    ]
...
export default OutwardFileFormate