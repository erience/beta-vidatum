  ...
  const fetchInwardData = async () => {
    ...
    try {
      const response = await apiConnector(
        "GET",
        `${apiUrl}/v2/admin/process/inward/inward-datewise?table=b_inward_v2&isin=c_isin&demattable=b_inward_info_v2`
      );
...
export default InwardProcessv2;
