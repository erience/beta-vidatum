...
const UserSearchInwardData = () => {
  const [loading, setLoading] = useState(true);
  const dataLf = useBenposeStore((state) => state.formData);
  console.log({ dataLf });
  //   const dataLf = location.state?.inwardData || [];
  //   console.log({ dataLf });
...

      {
        ...
        cell: ({ row }) => {
          ...
          return (
            <>
              <Link
                href={`/user/process/viewallinward/${btoa(dataLf.reference)}`}
...
export default UserSearchInwardData;
