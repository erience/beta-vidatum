...
const UserDemateInward = () => {
  ...
  const fetchDematData = async () => {
    try {
      const response = await apiConnector(
        "GET",
        `${apiUrl}/v2/user/process/demat-both`
      );
  ...
  const columns = useMemo(
    ...
    [data] // Add data as dependency since we're using it in the Action column
  );
...
export default UserDemateInward;
